...
\subsection{Motoren}
\graphiccol{hydraulikmotoren_tab}
...
\myeqstar{ 
\frac{M_A}{M_L} &= \frac{1}{\eta_{\text{hmP}} \cdot \eta_{\text{hmM}}} \cdot \frac{V_P}{V_M} \\
M_A &= \frac{p_A - p_B}{\eta_{ \text{hmP} } } \cdot \frac{V_P}{2 \pi} \\
M_L &= \eta_{\text{hmM} } \cdot \left( p_A - p_B \right) \cdot \frac{V_M}{2 \pi}
}
...
\myeqstar{
n_A &= \frac{1}{\eta_{\text{volP}} } \cdot \frac{Q_{PH}}{V_P} \\
\frac{n_L}{N_A} &= \eta_{\text{volP} } \cdot \eta_{\text{volM} } \cdot \frac{V_P}{V_M} \\
n_L &= \eta_{\text{volM} } \cdot \frac{Q_MH}{V_M}
}
